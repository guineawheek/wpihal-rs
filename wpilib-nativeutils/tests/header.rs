...
use wpilib_nativeutils::{Artifact, ArtifactType, Platform, ReleaseTrain, WPILibVersion};
...
fn download_header() {
    ...
    let local_maven = wpilib_nativeutils::get_local_maven(ReleaseTrain::Development);
