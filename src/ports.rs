use wpihal_sys::{HAL_GetNumAccumulators, HAL_GetNumAddressableLEDs, HAL_GetNumAnalogInputs, HAL_GetNumAnalogOutputs, HAL_GetNumAnalogTriggers, HAL_GetNumCTREPCMModules, HAL_GetNumCTREPDPChannels, HAL_GetNumCTREPDPModules, HAL_GetNumCTRESolenoidChannels, HAL_GetNumCounters, HAL_GetNumDigitalChannels, HAL_GetNumDigitalHeaders, HAL_GetNumDigitalPWMOutputs, HAL_GetNumDutyCycles, HAL_GetNumEncoders, HAL_GetNumPWMChannels, HAL_GetNumPWMHeaders, HAL_GetNumREVPDHChannels, HAL_GetNumREVPDHModules, HAL_GetNumREVPHChannels, HAL_GetNumREVPHModules, HAL_GetNumRelayChannels, HAL_GetNumRelayHeaders};
